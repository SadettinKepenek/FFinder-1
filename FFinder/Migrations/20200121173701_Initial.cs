        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhotoUrl = table.Column<string>(nullable: false),
                    ...
                    ViberUrl = table.Column<string>(maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FollowerId = table.Column<string>(nullable: false, defaultValueSql: "NEWID()"),
                    User1Id = table.Column<string>(maxLength: 450, nullable: false),
                    User2Id = table.Column<string>(maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_CommentRates",
                        column: x => x.CommentId,
                        principalTable: "Comment",
                        principalColumn: "CommentId");
                    table.ForeignKey(
                        name: "FK_CommentRates_User",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
